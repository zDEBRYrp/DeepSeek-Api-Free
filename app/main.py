...
def _build_tool_instruction(tools: Optional[List[Tool]]) -> str:
    ...
    lines = [
        ...
        "восклицательных знаков рядом. А вот РЕЗУЛЬТАТ работы инструмента придёт "
        "отдельным сообщением в СЛЕДУЮЩЕМ ответе, и ты продолжишь работу уже на его основе.",
